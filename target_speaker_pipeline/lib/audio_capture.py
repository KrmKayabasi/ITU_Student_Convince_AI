...
class RingBuffer:
    ...
    def overflow_count(self) -> int:
        ...
        return 0  # could track this with atomic counter
...
class SimulatedAudioCapture:
    ...
    def _voice_frame(
        ...
        # Formant filter (crude approximation via weighted harmonics)
        f1_gain = voice["brightness"] * voice["f1"] / 1000.0
        f2_gain = voice["brightness"] * voice["f2"] / 2500.0
        f3_gain = voice["brightness"] * voice["f3"] / 4000.0

        # Modulate by formant gains — crude but effective for differentiation
        formant_mod = (
            1.0
